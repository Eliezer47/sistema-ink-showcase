...
export const LAB_STAGES = Object.freeze([
  ...
  Object.freeze({ id: "delivery_ready", label: "Entrega", module: "entregas", action: "register_delivery", actionLabel: "Registrar entrega", instruction: "Entrega el pedido ficticio y genera el saldo final." }),
...
const transitions = Object.freeze({
  ...
  order_created: Object.freeze({ action: "record_deposit", nextStage: "deposit_paid", time: "09:18", label: "Anticipo registrado", detail: "Caja aplicó C$ 4,000 ficticios al pedido." }),
  ...
  delivery_ready: Object.freeze({ action: "register_delivery", nextStage: "balance_due", time: "14:10", label: "Entrega registrada", detail: "El pedido ficticio fue entregado y quedó con saldo pendiente." }),
  balance_due: Object.freeze({ action: "settle_balance", nextStage: "completed", time: "14:18", label: "Saldo cobrado", detail: "Caja registró el pago final ficticio y cerró el ciclo." }),
});
...
export function getLabSnapshot(state) {
  ...
  const paidAmount = completed ? LAB_SCENARIO.totalAmount : depositRecorded ? LAB_SCENARIO.depositAmount : 0;
  ...
  return {
    ...
    orderStatus: completed ? "Cerrado" : stageIndex >= 7 ? "Entregado" : stageIndex >= 4 ? "En producción" : stageIndex >= 2 ? "Confirmado" : "Cotización",
    ...
    deliveryStatus: stageIndex >= 7 ? "Entregada" : stageIndex >= 6 ? "Lista" : "Pendiente",
  };
}
